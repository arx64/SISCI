...
/**
 * ============================================================
 * FILE: views/domain/edit.php
 * ------------------------------------------------------------
 * Halaman edit domain ISO
 * Sistem Informasi Evaluasi Kepatuhan ISO/IEC 27001
 * ============================================================
 */

$pageTitle = 'Edit Domain ISO';
        ...
        <div class="col-md-9 col-lg-10 main-content p-4">
            ...
            <div class="d-flex align-items-center mb-4">
                ...
                <div>
                    <h2 class="fw-bold text-primary mb-1">
                        <i class="bi bi-pencil-square me-2"></i>Edit Domain ISO
                    </h2>
                    <p class="text-muted mb-0">Edit domain ISO/IEC 27001</p>
                </div>
            </div>
            ...
            <div class="card">
                <div class="card-header bg-white py-3">
                    <h5 class="fw-bold mb-0">Edit Domain: <?php echo $domain['kode_domain']; ?></h5>
                </div>
                <div class="card-body">
                    <form action="<?php echo BASE_URL; ?>index.php?page=domain&action=update" method="POST">
                        <?php echo csrfField(); ?>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="text" 
                                       ...
                                       id="kode_domain" 
                                       name="kode_domain" 
                                       value="<?php echo $domain['kode_domain']; ?>"
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="text" 
                                       ...
                                       id="nama_domain" 
                                       name="nama_domain" 
                                       value="<?php echo htmlspecialchars($domain['nama_domain']); ?>"
                        ...
                        <div class="mb-4">
                            ...
                            <textarea class="form-control" 
                                      ...
                                      name="deskripsi" 
                                      rows="4"
                                      placeholder="Masukkan deskripsi domain..."><?php echo htmlspecialchars($domain['deskripsi']); ?></textarea>
                            <div class="form-text">
