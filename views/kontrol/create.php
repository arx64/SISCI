...
/**
 * ============================================================
 * FILE: views/kontrol/create.php
 * ------------------------------------------------------------
 * Halaman tambah kontrol ISO baru
 * Sistem Informasi Evaluasi Kepatuhan ISO/IEC 27001
 * ============================================================
 */

$pageTitle = 'Tambah Kontrol ISO';
        ...
        <div class="col-md-9 col-lg-10 main-content p-4">
            ...
            <div class="d-flex align-items-center mb-4">
                ...
                <div>
                    <h2 class="fw-bold text-primary mb-1">
                        <i class="bi bi-plus-circle me-2"></i>Tambah Kontrol ISO
                    </h2>
                    <p class="text-muted mb-0">Tambah kontrol baru ISO/IEC 27001</p>
                </div>
            </div>
            ...
            <div class="card">
                <div class="card-header bg-white py-3">
                    <h5 class="fw-bold mb-0">Form Kontrol Baru</h5>
                </div>
                <div class="card-body">
                    <form action="<?php echo BASE_URL; ?>index.php?page=kontrol&action=store" method="POST">
                        <?php echo csrfField(); ?>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4 mb-3">
                                ...
                                <select class="form-select" id="level_maksimal" name="level_maksimal">
                                    <option value="5" selected>5 (Maksimal)</option>
                        ...
                        <div class="mb-4">
                            ...
                            <textarea class="form-control" 
                                      ...
                                      name="deskripsi" 
                                      rows="5"
                                      placeholder="Masukkan deskripsi kontrol..."></textarea>
                            <div class="form-text">
